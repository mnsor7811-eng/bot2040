...
def callback_handler(call):
    ...
    # ==================== حسابات تيليجرام جاهزة (TG-Lion & Spider) ====================
        ...
        srv_name = "TG-Lion" if srv_num == "1" else "Spider Service"
        msg_txt = f"💯 **الحسابات المتاحة عبر السيرفر {srv_num} ({srv_name})**:\n\nاختر الدولة المطلوبة:"
        try:
        ...
        msg_txt = "⏳ **قسم الحسابات القديمة والمعتقة (TG-Lion)**:\n\nاختر عمر الحساب المطلوب:"
        try:
        ...
        detail_msg = (
            ...
            f"▫️ **الدولة** : {c_name}\n"
            f"▫️ **السعر (شامل الربح)** : `${price:.2f}`\n"
            f"▫️ **الكمية المتوفرة** : {count} حساب\n\n"
            f"⚠️ **ملاحظة**: بمجرد الشراء سيتم حجز الرقم لك مباشرة، وستتمكن من جلب كود تسجيل الدخول وكلمة سر التحقق بخطوتين (2FA) بضغطة زر."
        )
