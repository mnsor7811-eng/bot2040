...
def filter_smm_services(target_type):
    ...
    for srv in services:
        ...
        if target_type == 'tg_mem' and ('telegram' in name_cat or 'تيليجرام' in name_cat) and ('member' in name_cat or 'sub' in name_cat or 'متابع' in name_cat): match = True
        elif target_type == 'tg_view' and ('telegram' in name_cat or 'تيليجرام' in name_cat) and ('view' in name_cat or 'post' in name_cat or 'مشاهد' in name_cat): match = True
        elif target_type == 'ig_fol' and ('instagram' in name_cat or 'انستجرام' in name_cat) and ('follow' in name_cat or 'متابع' in name_cat): match = True
        elif target_type == 'ig_like' and ('instagram' in name_cat or 'انستجرام' in name_cat) and ('like' in name_cat or 'لايك' in name_cat or 'اعجاب' in name_cat): match = True
        elif target_type == 'tk_view' and ('tiktok' in name_cat or 'تيك توك' in name_cat) and ('view' in name_cat or 'مشاهد' in name_cat): match = True
        elif target_type == 'tk_fol' and ('tiktok' in name_cat or 'تيك توك' in name_cat) and ('follow' in name_cat or 'متابع' in name_cat): match = True
        elif target_type == 'fb_fol' and ('facebook' in name_cat or 'فيسبوك' in name_cat) and ('follow' in name_cat or 'متابع' in name_cat): match = True
        elif target_type == 'yt_view' and ('youtube' in name_cat or 'يوتيوب' in name_cat) and ('view' in name_cat or 'مشاهد' in name_cat): match = True
