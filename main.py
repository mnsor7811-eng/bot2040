...
# ==================== إعدادات بايننس بايو (Binance Pay) الجديدة ====================
...
# ==================== تعيين قائمة الأوامر (Menu Commands) الشاملة في تيليجرام ====================
...
def callback_handler(call):
    ...
    # ==================== دمج شحن بايننس بايو التلقائي الجديد ====================
    elif call.data == "deposit_binance" or call.data == "pay_binance":
        bot.answer_callback_query(call.id)
        msg = bot.send_message(
            chat_id,
            "🟡 **شحن رصيد عبر Binance Pay (تلقائي)**\n\n"
            "⚠️ تنبيه مهم ‼️\n"
...
# ==================== دوال معالجة الخطوات التابعة لبايننس (إضافية) ====================
def process_amount(message):
    ...
    try:
        ...
        markup.add(InlineKeyboardButton("رجوع", callback_data="start_over"))

        bot.send_message(
            chat_id,
            f"🟡 **تفاصيل الدفع عبر Binance Pay**\n\n"
        ...
        msg = bot.send_message(chat_id, "❌ خطأ: يرجى إرسال رقم صحيح للمبلغ (مثال: 10 أو 5.5):")
        bot.register_next_step_handler(msg, process_amount)
