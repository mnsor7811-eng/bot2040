...
def filter_smm_services(target_type):
    ...
    keywords = {
        'tg_mem': ['telegram', 'تيليجرام', 'تليجرام', 'member', 'أعضاء', 'اعضاء'],
        'tg_view': ['telegram', 'تيليجرام', 'تليجرام', 'view', 'مشاهد', 'post'],
        'ig_fol': ['instagram', 'انستا', 'انستجرام', 'follow', 'متابع'],
        'ig_like': ['instagram', 'انستا', 'انستجرام', 'like', 'لايك', 'اعجاب'],
        'tk_view': ['tiktok', 'تيك', 'view', 'مشاهد'],
        'tk_fol': ['tiktok', 'تيك', 'follow', 'متابع'],
        'fb_fol': ['facebook', 'فيسبوك', 'فيس', 'follow', 'like'],
        'yt_view': ['youtube', 'يوتيوب', 'view', 'مشاهد']
    }
    
    target_keys = keywords.get(target_type, [])
    ...
    # نظام احتياطي: إرجاع أول 25 خدمة في حال عدم تطابق الفلاتر بدلاً من إظهار القائمة فارغة
