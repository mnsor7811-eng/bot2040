        ...
        try:
            if os.path.exists(DB_FILE):
                with open(DB_FILE, 'rb') as f:
                    ...
                    caption = (
                        f"💾 <b>نسخة احتياطية كاملة لقاعدة البيانات</b>\n"
                        f"📅 التاريخ: <code>{now_str}</code>\n"
                        f"👥 تحتوي على جميع بيانات المستخدمين، الأرصدة، وسجلات الطلبات والمبيعات.\n\n"
                        f"🔒 احتفظ بهذا الملف! يمكنك استخدامه لاستعادة بيانات البوت في أي وقت عند نقله أو تحديثه."
                    )
