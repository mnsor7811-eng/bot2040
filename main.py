...
TOKEN = '8927305428:AAFZG-mYzFOf2OtIvOHusRXoGj325btMwGs'
...
# ==================== 7. استقبال المدخلات والخطوات (تم إصلاحها لتدعم المشرف) ====================
        ...
        if step == 'ADMIN_BROADCAST':
            ...
            for (u_id,) in all_users:
                try:
                    ...
                    success_count += 1
                    time.sleep(0.05) # لتجنب حظر تليجرام للسبام
                except Exception:
                    fail_count += 1
