...
def callback_handler(call):
    ...
    # ==================== حسابات تيليجرام جاهزة ====================
        ...
        try:
            ...
            # إرسال رسالة جديدة مستقلة أيضاً لضمان وصولها للمستخدم فوراً حتى لو حدث تعليق أو تجاوز للواجهة
            try:
        ...
        lookup_key = parts[4] if len(parts) > 4 else ""
