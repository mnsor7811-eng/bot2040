...
def callback_handler(call):
    ...
    # 10. مخزون الحسابات القديمة (سيرفر 3)
        ...
        try:
            ...
            cursor.execute("SELECT COUNT(*), SUM(cost) FROM ready_accounts_orders")
        ...
        msg = (f"📊 **إحصائيات البوت الشاملة والأرصدة الدائمة:**\n\n"
               ...
               f"💯 عمليات الحسابات الجاهزة: `{ready_count}` (مجموع: `${ready_spent:.2f}`)\n"
               f"💵 إجمالي المبيعات الكلي: `${(num_spent + smm_spent + ready_spent):.2f}`")
