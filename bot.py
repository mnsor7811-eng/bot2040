...
DEFAULT_PRICE = 0.50      # سعر افتراضي في حال تعذر جلب السعر
...
# قاموس مخصص لترجمة أرقام الدول إلى أسماء وأعلام
COUNTRY_NAMES = {
    "0": "🇷🇺 روسيا", "1": "🇺🇦 أوكرانيا", "2": "🇰🇿 كازاخستان", "3": "🇨🇳 الصين",
    "4": "🇵🇭 الفلبين", "6": "🇮🇩 إندونيسيا", "7": "🇲🇾 ماليزيا", "13": "🇩🇪 ألمانيا",
    "15": "🇵🇱 بولندا", "16": "🇬🇧 بريطانيا", "19": "🇳🇬 نيجيريا", "21": "🇪🇬 مصر",
    "22": "🇮🇳 الهند", "32": "🇷🇴 رومانيا", "36": "🇨🇦 كندا", "73": "🇧🇷 البرازيل",
    "78": "🇫🇷 فرنسا", "86": "🇮🇹 إيطاليا", "187": "🇺🇸 أمريكا"
}

PRICES_CACHE = {}
CACHE_LAST_UPDATE = {}
CACHE_DURATION = 300 # تخزين مؤقت للأسعار لمدة 5 دقائق
...
# ==================== 3. جلب الأسعار والطلبات من Grizzly ====================
...
# ==================== 4. لوحات الأزرار والعرض في عمودين ====================
...
# --- دالة عرض الدول في عمودين مرتبين مع أسعارها الحقيقية والربح ---
def countries_keyboard_fast(server_id, service_code):
    markup = InlineKeyboardMarkup()
    prices = fetch_server_prices(server_id, service_code)

    buttons = []
    # تجميع الدول المتاحة من السيرفر وإعطائها أشكال وأسماء مرتبة
    ...
    # رصف الأزرار في عمودين (2 زر في كل صف)
