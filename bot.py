...
# قاموس الدول الموسّع والمصحح لجميع الأكواد البسيطة والخماسية/المتقدمة
COUNTRY_MAP = {
    ...
    "102": {"name": "المملكة المتحدة (افتراضي)", "flag": "🇬🇧"}, "103": {"name": "فرنسا (افتراضي)", "flag": "🇫🇷"},
    "104": {"name": "إسبانيا (افتراضي)", "flag": "🇪🇸"}, "105": {"name": "ألمانيا (افتراضي)", "flag": "🇩🇪"},
    "106": {"name": "إيطاليا (افتراضي)", "flag": "🇮🇹"}, "114": {"name": "الإمارات", "flag": "🇦🇪"},
    "117": {"name": "البرتغال", "flag": "🇵🇹"}, "161": {"name": "اليمن", "flag": "🇾🇪"},
    "154": {"name": "السنغال", "flag": "🇸🇳"}, "155": {"name": "تونس", "flag": "🇹🇳"},
    "156": {"name": "زامبيا", "flag": "🇿🇲"}, "157": {"name": "زيمبابوي", "flag": "🇿🇼"},
    "158": {"name": "ماكاو", "flag": "🇲🇴"}, "159": {"name": "مالاوي", "flag": "🇲🇼"},
    "160": {"name": "المالديف", "flag": "🇲🇻"}, "162": {"name": "موريتانيا", "flag": "🇲🇷"},
    "163": {"name": "موريشيوس", "flag": "🇲🇺"}, "164": {"name": "منغوليا", "flag": "🇲🇳"},
    "165": {"name": "الجبل الأسود", "flag": "🇲🇪"}, "166": {"name": "موزمبيق", "flag": "🇲🇿"},
    "167": {"name": "ناميبيا", "flag": "🇳🇦"}, "168": {"name": "كاليدونيا الجديدة", "flag": "🇳🇨"},
...
def get_country_info(code_str):
    ...
    # حل مشكلة الأكواد المتقدمة (مثل 10016 أو 10231)
    base_code = code_str[-3:] if len(code_str) > 3 else code_str
    if base_code in COUNTRY_MAP:
        return f"{COUNTRY_MAP[base_code]['name']} (خاص)", COUNTRY_MAP[base_code]['flag']
...
# --- عرض 20 دولة مع الأعلام والأكواد المصححة ---
...
def callback_handler(call):
    ...
    # --- معالجة شراء الرقم والتنسيق الاحترافي الجديد المشابه للصورة الأولى ---
        ...
        if "ACCESS_NUMBER" in res:
            ...
            # ضبط الرقم بإضافة المفتاح + في بدايته لسهولة النسخ
            ...
            # صياغة واجهة الرسالة بالشكل الاحترافي (نفس تصميم الصورة الأولى)
