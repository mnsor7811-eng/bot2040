...
# سيرفرات الرشق وشحن الألعاب (SMM Panels) المأخوذة من PHP
SMM_PANELS = {
...
USER_STEPS = {}  # لتتبع الخطوات في خدمات الرشق
...
def smm_panel_keyboard():
    ...
    markup.add(InlineKeyboardButton("🎮 شحن شدات ببجي / جوزات", callback_data="smm_order_103"))
    markup.add(InlineKeyboardButton("🔙 العودة للقائمة الرئيسية", callback_data="back_main"))
    return markup
...
# ==================== 6. استقبال المدخلات الصوتية والنصية (الرشق) ====================
...
def handle_user_steps(message):
    ...
    if step_data['step'] == 'WAITING_LINK':
        ...
        price_per_1000 = 1.50  # سعر افتراضي للخدمة
