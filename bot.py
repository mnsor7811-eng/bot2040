...
COUNTRY_MAP = {
    ...
    "11": {"name": "أوزبكستان", "flag": "🇺🇿"},
    "12": {"name": "كمبوديا", "flag": "🇰🇭"},
    "13": {"name": "ألمانيا", "flag": "🇩🇪"},
    "14": {"name": "ليتوانيا", "flag": "🇱🇹"},
    "15": {"name": "بولندا", "flag": "🇵🇱"},
    "16": {"name": "بريطانيا", "flag": "🇬🇧"},
    "17": {"name": "مدغشقر", "flag": "🇲🇬"},
    "18": {"name": "سويسرا", "flag": "🇨🇭"},
    "19": {"name": "نيجيريا", "flag": "🇳🇬"},
    "20": {"name": "هولندا", "flag": "🇳🇱"},
    "21": {"name": "مصر", "flag": "🇪🇬"},
    "22": {"name": "الهند", "flag": "🇮🇳"},
    "23": {"name": "أيرلندا", "flag": "🇮🇪"},
    "24": {"name": "لاتفيا", "flag": "🇱🇻"},
    "25": {"name": "المغرب", "flag": "🇲🇦"},
    "26": {"name": "غانا", "flag": "🇬🇭"},
    "27": {"name": "إسبانيا", "flag": "🇪🇸"},
    "28": {"name": "بلجيكا", "flag": "🇧🇪"},
    "29": {"name": "باكستان", "flag": "🇵🇰"},
    "30": {"name": "ألبانيا", "flag": "🇦🇱"},
    "31": {"name": "السويد", "flag": "🇸🇪"},
    ...
    "36": {"name": "كندا", "flag": "🇨🇦"},
    "37": {"name": "مالي", "flag": "🇲🇱"},
    "38": {"name": "إثيوبيا", "flag": "🇪🇹"},
    "39": {"name": "البرتغال", "flag": "🇵🇹"},
    "40": {"name": "بنغلاديش", "flag": "🇧🇩"},
    "41": {"name": "تركيا", "flag": "🇹🇷"},
    "42": {"name": "التشيك", "flag": "🇨🇿"},
    "43": {"name": "سريلانكا", "flag": "🇱🇰"},
    "44": {"name": "بيرو", "flag": "🇵🇪"},
    "45": {"name": "باكستان", "flag": "🇵🇰"},
    "46": {"name": "تايلاند", "flag": "🇹🇭"},
    "47": {"name": "السعودية", "flag": "🇸🇦"},
    "48": {"name": "العراق", "flag": "🇮🇶"},
    "49": {"name": "جنوب أفريقيا", "flag": "🇿🇦"},
    "50": {"name": "ساحل العاج", "flag": "🇨🇮"},
    "51": {"name": "الأرجنتين", "flag": "🇦🇷"},
    "52": {"name": "الأردن", "flag": "🇯🇴"},
    "53": {"name": "بيلاروسيا", "flag": "🇧🇾"},
    "54": {"name": "نيبال", "flag": "🇳🇵"},
    "55": {"name": "فنلندا", "flag": "🇫🇮"},
    "56": {"name": "المجر", "flag": "🇭🇺"},
    "57": {"name": "المكسيك", "flag": "🇲🇽"},
    "58": {"name": "الجزائر", "flag": "🇩🇿"},
    "59": {"name": "أنغولا", "flag": "🇦🇴"},
    "60": {"name": "الكونغو", "flag": "🇨🇬"},
    "61": {"name": "الكاميرون", "flag": "🇨🇲"},
    "62": {"name": "تشاد", "flag": "🇹🇩"},
    "63": {"name": "غينيا", "flag": "🇬🇳"},
    "64": {"name": "سيراليون", "flag": "🇸🇱"},
    "65": {"name": "بنين", "flag": "🇧🇯"},
    "66": {"name": "توغو", "flag": "🇹🇬"},
    "67": {"name": "النيجر", "flag": "🇳🇪"},
    "68": {"name": "رواندا", "flag": "🇷🇼"},
    "69": {"name": "أوغندا", "flag": "🇺🇬"},
    "70": {"name": "بوروندي", "flag": "🇧🇮"},
    "71": {"name": "تنزانيا", "flag": "🇹🇿"},
    "72": {"name": "زامبيا", "flag": "🇿🇲"},
    "73": {"name": "البرازيل", "flag": "🇧🇷"},
    "74": {"name": "بوليفيا", "flag": "🇧🇴"},
    "75": {"name": "تشيلي", "flag": "🇨🇱"},
    "76": {"name": "الإكوادور", "flag": "🇪🇨"},
    "77": {"name": "باراغواي", "flag": "🇵🇾"},
    "78": {"name": "سورينام", "flag": "🇸🇷"},
    "79": {"name": "أوروغواي", "flag": "🇺🇾"},
    "80": {"name": "جورجيا", "flag": "🇬🇪"},
    "81": {"name": "أرمينيا", "flag": "🇦🇲"},
    "82": {"name": "طاجيكستان", "flag": "🇹🇯"},
    "83": {"name": "تركمانستان", "flag": "🇹🇲"},
    "84": {"name": "أذربيجان", "flag": "🇦🇿"},
    "85": {"name": "مولدوفا", "flag": "🇲🇩"},
    "86": {"name": "إيطاليا", "flag": "🇮🇹"},
    "87": {"name": "اليونان", "flag": "🇬🇷"},
    "88": {"name": "صربيا", "flag": "🇷🇸"},
    "89": {"name": "كرواتيا", "flag": "🇭🇷"},
    "90": {"name": "بلغاريا", "flag": "🇧🇬"},
    "91": {"name": "سلوفاكيا", "flag": "🇸🇰"},
    "92": {"name": "سلوفينيا", "flag": "🇸🇮"},
    "93": {"name": "مقدونيا", "flag": "🇲🇰"},
    "94": {"name": "البوسنة", "flag": "🇧🇦"},
    "95": {"name": "السودان", "flag": "🇸🇩"},
    "96": {"name": "ليبيا", "flag": "🇱🇾"},
    "97": {"name": "جيبوتي", "flag": "🇩🇯"},
    "98": {"name": "الصومال", "flag": "🇸🇴"},
    "99": {"name": "موريتانيا", "flag": "🇲🇷"},
    "100": {"name": "تونس", "flag": "🇹🇳"},
    "101": {"name": "فلسطين", "flag": "🇵🇸"},
    "102": {"name": "سوريا", "flag": "🇸🇾"},
    "103": {"name": "لبنان", "flag": "🇱🇧"},
    "104": {"name": "الكويت", "flag": "🇰🇼"},
    "105": {"name": "عمان", "flag": "🇴🇲"},
    "106": {"name": "قطر", "flag": "🇶🇦"},
    "107": {"name": "البحرين", "flag": "🇧🇭"},
    "108": {"name": "اليمن", "flag": "🇾🇪"},
    "109": {"name": "أفغانستان", "flag": "🇦🇫"},
    "110": {"name": "منغوليا", "flag": "🇲🇳"},
    "111": {"name": "تايوان", "flag": "🇹🇼"},
    "112": {"name": "هونغ كونغ", "flag": "🇭🇰"},
    "113": {"name": "ماكاو", "flag": "🇲🇴"},
    "114": {"name": "الإمارات", "flag": "🇦🇪"},
    "115": {"name": "سنغافورة", "flag": "🇸🇬"},
    "116": {"name": "كوريا الجنوبية", "flag": "🇰🇷"},
    "117": {"name": "اليابان", "flag": "🇯🇵"},
    "118": {"name": "أستراليا", "flag": "🇦🇺"},
    "119": {"name": "نيوزيلندا", "flag": "🇳🇿"},
    "120": {"name": "بابوا غينيا", "flag": "🇵🇬"},
    "121": {"name": "فيجي", "flag": "🇫🇯"},
    "122": {"name": "أمريكا", "flag": "🇺🇸"},
    "123": {"name": "جامايكا", "flag": "🇯🇲"},
    "124": {"name": "هايتي", "flag": "🇭🇹"},
    "125": {"name": "الدومينيكان", "flag": "🇩🇴"},
    "126": {"name": "كوبا", "flag": "🇨🇺"},
    "127": {"name": "غواتيمالا", "flag": "🇬🇹"},
    "128": {"name": "بليز", "flag": "🇧🇿"},
    "129": {"name": "السلفادور", "flag": "🇸🇻"},
    "130": {"name": "هندوراس", "flag": "🇭🇳"},
    "131": {"name": "نيكاراغوا", "flag": "🇳🇮"},
    "132": {"name": "كوستاريكا", "flag": "🇨🇷"},
    "133": {"name": "بنما", "flag": "🇵🇦"},
    "134": {"name": "بربادوس", "flag": "🇧🇧"},
    "135": {"name": "غرينادا", "flag": "🇬🇩"},
    "136": {"name": "جزر البهاما", "flag": "🇧🇸"},
    "137": {"name": "غويانا", "flag": "🇬🇾"},
    "138": {"name": "آيسلندا", "flag": "🇮🇸"},
    "139": {"name": "لوكسمبورغ", "flag": "🇱🇺"},
    "140": {"name": "مالطا", "flag": "🇲🇹"},
    "141": {"name": "قبرص", "flag": "🇨🇾"},
    "142": {"name": "الجبل الأسود", "flag": "🇲🇪"},
    "143": {"name": "كوسوفو", "flag": "🇽🇰"},
    "144": {"name": "أندورا", "flag": "🇦🇩"},
    "145": {"name": "سان مارينو", "flag": "🇸🇲"},
    "146": {"name": "موناكو", "flag": "🇲🇨"},
    "147": {"name": "ليختنشتاين", "flag": "🇱🇮"},
    "148": {"name": "زامبيا", "flag": "🇿🇲"},
    "149": {"name": "زيمبابوي", "flag": "🇿🇼"},
    "150": {"name": "بوتسوانا", "flag": "🇧🇼"},
    "151": {"name": "ناميبيا", "flag": "🇳🇦"},
    "152": {"name": "ملاوي", "flag": "🇲🇼"},
    "153": {"name": "موزمبيق", "flag": "🇲🇿"},
    "154": {"name": "السنغال", "flag": "🇸🇳"},
    "155": {"name": "غامبيا", "flag": "🇬🇲"},
    "156": {"name": "ليبيريا", "flag": "🇱🇷"},
    "157": {"name": "بوركينا فاسو", "flag": "🇧🇫"},
    "158": {"name": "الغابون", "flag": "🇬🇦"},
    "159": {"name": "غينيا الاستوائية", "flag": "🇬🇶"},
    "160": {"name": "الرأس الأخضر", "flag": "🇨🇻"},
    "161": {"name": "ساو تومي", "flag": "🇸🇹"},
    "162": {"name": "جزر سيشل", "flag": "🇸🇨"},
    "163": {"name": "موريشيوس", "flag": "🇲🇺"},
    "164": {"name": "جزر القمر", "flag": "🇰🇲"},
    "165": {"name": "إريتريا", "flag": "🇪🇷"},
    "166": {"name": "جنوب السودان", "flag": "🇸🇸"},
    "167": {"name": "المالديف", "flag": "🇲🇻"},
    "168": {"name": "بوتان", "flag": "🇧🇹"},
    "169": {"name": "بروناي", "flag": "🇧🇳"},
    "170": {"name": "تيمور الشرقية", "flag": "🇹🇱"},
    "171": {"name": "الساموا", "flag": "🇼🇸"},
    "172": {"name": "تونغا", "flag": "🇹🇴"},
    "173": {"name": "فانواتو", "flag": "🇻🇺"},
    "174": {"name": "جزر سليمان", "flag": "🇸🇧"},
    "175": {"name": "كيريباتي", "flag": "🇰🇮"},
    "176": {"name": "ميكرونيزيا", "flag": "🇫🇲"},
    "177": {"name": "بالاو", "flag": "🇵🇼"},
    "178": {"name": "جزر مارشال", "flag": "🇲🇭"},
    "179": {"name": "ناورو", "flag": "🇳🇷"},
    "180": {"name": "توفالو", "flag": "🇹🇻"},
    "187": {"name": "أمريكا", "flag": "🇺🇸"},
    "201": {"name": "المملكة المتحدة", "flag": "🇬🇧"},
    "202": {"name": "فرنسا", "flag": "🇫🇷"},
    "203": {"name": "إسبانيا", "flag": "🇪🇸"},
    "204": {"name": "ألمانيا", "flag": "🇩🇪"},
    "205": {"name": "إيطاليا", "flag": "🇮🇹"},

    # أكواد الخطوط الافتراضية والخماسية السيرفرية (Grizzly / SMS-Man)
    "1003": {"name": "الصين (خط 2)", "flag": "🇨🇳"},
    "1008": {"name": "كينيا (خط 2)", "flag": "🇰🇪"},
    "1016": {"name": "بريطانيا (خط 2)", "flag": "🇬🇧"},
    "10016": {"name": "بريطانيا (خط 3)", "flag": "🇬🇧"},
    "10227": {"name": "إسبانيا (خط 2)", "flag": "🇪🇸"},
    "10231": {"name": "السويد (خط 2)", "flag": "🇸🇪"},
    "10348": {"name": "إستونيا (خط 2)", "flag": "🇪🇪"},
    "10349": {"name": "أذربيجان (خط 2)", "flag": "🇦🇿"},
    "10350": {"name": "كندا (خط 2)", "flag": "🇨🇦"},
    "10351": {"name": "مالي (خط 2)", "flag": "🇲🇱"},
    "1062": {"name": "تشاد (خط 2)", "flag": "🇹🇩"}
}

# ==================== دالة استخراج معلومات الدولة الذكية ====================
def get_country_info(code_str):
    ...
    # 2. استخراج الكود في حال كان خماسياً (مثل 10016 أو 10227)
    if len(code_str) >= 4:
        clean_code = code_str.replace("100", "").replace("10", "")
        if clean_code in COUNTRY_MAP:
            return COUNTRY_MAP[clean_code]['name'], COUNTRY_MAP[clean_code]['flag']
            
        tail_code = str(int(code_str) % 100)
        if tail_code in COUNTRY_MAP:
            return COUNTRY_MAP[tail_code]['name'], COUNTRY_MAP[tail_code]['flag']

    # 3. محاولة المطابقة مع آخر 3 أرقام
    base_code = code_str[-3:] if len(code_str) > 3 else code_str
    if base_code in COUNTRY_MAP:
        return COUNTRY_MAP[base_code]['name'], COUNTRY_MAP[base_code]['flag']
    
    # 4. خيار احتياطي عند عدم العثور على أي تطابق
