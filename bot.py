...
def main_keyboard(user_id):
    ...
    btn_recharge = InlineKeyboardButton("🎳 شحن الرصيد / الاشتراكات", callback_data="recharge_main")
...
def ai_section_keyboard():
    ...
    btn_buy_pkg = InlineKeyboardButton("💳 شحن رصيد / شراء باقة", callback_data="recharge_ai")
...
def callback_handler(call):
    ...
    elif call.data in ["recharge_main", "recharge_ai"]:
