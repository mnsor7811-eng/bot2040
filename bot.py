...
def callback_handler(call):
    ...
    # === معالجة باقي الأزرار الرئيسية ===
        ...
        bot.send_message(chat_id, f"🎳 **لشحن حسابك يرجى التواصل مع الإدارة:**\n👤 Admin: {ADMIN_USERNAME}")
        ...
        bot.send_message(chat_id, "💎 **ربح روبل مجاناً:**\nقم بدعوة أصدقائك للحصول على رصيد مجاني لكل استخدام.")
