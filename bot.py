...
# ==================== قاموس الدول الشامل والخطوط الإضافية ====================
COUNTRY_MAP = {
    # أكواد الدول الأساسية
    ...
    "44": {"name": "البيرو", "flag": "🇵🇪"}, "45": {"name": "باكستان", "flag": "🇵🇰"},
    "46": {"name": "تايلاند", "flag": "🇹🇭"}, "47": {"name": "السعودية", "flag": "🇸🇦"},
    "48": {"name": "العراق", "flag": "🇮🇶"}, "49": {"name": "جنوب إفريقيا", "flag": "🇿🇦"},
    "50": {"name": "ساحل العاج", "flag": "🇨🇮"}, "51": {"name": "الأرجنتين", "flag": "🇦🇷"},
    "52": {"name": "الأردن", "flag": "🇯🇴"}, "53": {"name": "بيلاروسيا", "flag": "🇧🇾"},
    "54": {"name": "نيبال", "flag": "🇳🇵"}, "55": {"name": "فنلندا", "flag": "🇫🇮"},
    "56": {"name": "المجر", "flag": "🇭🇺"}, "57": {"name": "المكسيك", "flag": "🇲🇽"},
    "58": {"name": "الجزائر", "flag": "🇩🇿"}, "59": {"name": "أنغولا", "flag": "🇦🇴"},
    "60": {"name": "الكونغو", "flag": "🇨🇬"}, "61": {"name": "كاميرون", "flag": "🇨🇲"},
    "62": {"name": "تشاد", "flag": "🇹🇩"}, "63": {"name": "غينيا", "flag": "🇬🇳"},
    "64": {"name": "سيراليون", "flag": "🇸🇱"}, "65": {"name": "بنين", "flag": "🇧🇯"},
    "66": {"name": "توغو", "flag": "🇹🇬"}, "67": {"name": "النيجر", "flag": "🇳🇪"},
    "68": {"name": "رواندا", "flag": "🇷🇼"}, "69": {"name": "أوغندا", "flag": "🇺🇬"},
    "70": {"name": "بوروندي", "flag": "🇧🇮"}, "71": {"name": "تنزانيا", "flag": "🇹🇿"},
    "72": {"name": "زامبيا", "flag": "🇿🇲"}, "73": {"name": "البرازيل", "flag": "🇧🇷"},
    "74": {"name": "بوليفيا", "flag": "🇧🇴"}, "75": {"name": "تشيلي", "flag": "🇨🇱"},
    "76": {"name": "الإكوادور", "flag": "🇪🇨"}, "77": {"name": "باراغواي", "flag": "🇵🇾"},
    "78": {"name": "فرنسا", "flag": "🇫🇷"}, "79": {"name": "كينيا", "flag": "🇰🇪"},
    "80": {"name": "جورجيا", "flag": "🇬🇪"}, "81": {"name": "أرمينيا", "flag": "🇦🇲"},
    "82": {"name": "طاجيكستان", "flag": "🇹🇯"}, "83": {"name": "تركمانستان", "flag": "🇹🇲"},
    "84": {"name": "أذربيجان", "flag": "🇦🇿"}, "85": {"name": "مولدوفا", "flag": "🇲🇩"},
    "86": {"name": "إيطاليا", "flag": "🇮🇹"}, "87": {"name": "اليونان", "flag": "🇬🇷"},
    "88": {"name": "صربيا", "flag": "🇷🇸"}, "89": {"name": "كرواتيا", "flag": "🇭🇷"},
    "90": {"name": "بلغاريا", "flag": "🇧🇬"}, "91": {"name": "سلوفاكيا", "flag": "🇸🇰"},
    "92": {"name": "سلوفينيا", "flag": "🇸🇮"}, "93": {"name": "مقدونيا", "flag": "🇲🇰"},
    "94": {"name": "البوسنة", "flag": "🇧🇦"}, "95": {"name": "السودان", "flag": "🇸🇩"},
    "96": {"name": "ليبيا", "flag": "🇱🇾"}, "97": {"name": "جيبوتي", "flag": "🇩🇯"},
    "98": {"name": "الصومال", "flag": "🇸🇴"}, "99": {"name": "موريتانيا", "flag": "🇲🇷"},
    "100": {"name": "فلسطين", "flag": "🇵🇸"}, "101": {"name": "سوريا", "flag": "🇸🇾"},
    "102": {"name": "المملكة المتحدة", "flag": "🇬🇧"}, "103": {"name": "فرنسا", "flag": "🇫🇷"},
    "104": {"name": "إسبانيا", "flag": "🇪🇸"}, "105": {"name": "ألمانيا", "flag": "🇩🇪"},
    "106": {"name": "إيطاليا", "flag": "🇮🇹"}, "114": {"name": "الإمارات", "flag": "🇦🇪"},
    "117": {"name": "البرتغال", "flag": "🇵🇹"}, "154": {"name": "السنغال", "flag": "🇸🇳"},
    "155": {"name": "تونس", "flag": "🇹🇳"}, "156": {"name": "زامبيا", "flag": "🇿🇲"},
    "157": {"name": "زيمبابوي", "flag": "🇿🇼"}, "158": {"name": "ماكاو", "flag": "🇲🇴"},
    "159": {"name": "مالاوي", "flag": "🇲🇼"}, "160": {"name": "المالديف", "flag": "🇲🇻"},
    "161": {"name": "اليمن", "flag": "🇾🇪"}, "162": {"name": "موريتانيا", "flag": "🇲🇷"},
    "163": {"name": "موريشيوس", "flag": "🇲🇺"}, "164": {"name": "منغوليا", "flag": "🇲🇳"},
    "165": {"name": "الجبل الأسود", "flag": "🇲🇪"}, "166": {"name": "موزمبيق", "flag": "🇲🇿"},
    "167": {"name": "ناميبيا", "flag": "🇳🇦"}, "168": {"name": "كاليدونيا", "flag": "🇳🇨"},
    "169": {"name": "نيكاراغوا", "flag": "🇳🇮"}, "170": {"name": "النيجر", "flag": "🇳🇪"},
    "171": {"name": "عمان", "flag": "🇴🇲"}, "172": {"name": "بنما", "flag": "🇵🇦"},
    "173": {"name": "بابوا غينيا", "flag": "🇵🇬"}, "174": {"name": "باراغواي", "flag": "🇵🇾"},
    "175": {"name": "بورتوريكو", "flag": "🇵🇷"}, "176": {"name": "قطر", "flag": "🇶🇦"},
    "187": {"name": "أمريكا", "flag": "🇺🇸"},

    # أكواد الخطوط الافتراضية والخماسية التابعة للسيرفرات (Grizzly / SMS-Man)
    "1003": {"name": "الصين (خط افتراضي)", "flag": "🇨🇳"},
    "1008": {"name": "كينيا (خط افتراضي)", "flag": "🇰🇪"},
    "1016": {"name": "بريطانيا (خط افتراضي)", "flag": "🇬🇧"},
    "10016": {"name": "بريطانيا (خط 2)", "flag": "🇬🇧"},
    "10227": {"name": "إسبانيا (خط افتراضي)", "flag": "🇪🇸"},
    "10231": {"name": "السويد (خط افتراضي)", "flag": "🇸🇪"},
    "10348": {"name": "إستونيا (خط افتراضي)", "flag": "🇪🇪"},
    "10349": {"name": "أذربيجان (خط افتراضي)", "flag": "🇦🇿"},
    "10350": {"name": "كندا (خط افتراضي)", "flag": "🇨🇦"},
    "10351": {"name": "مالي (خط افتراضي)", "flag": "🇲🇱"},
    "1062": {"name": "تشاد (خط افتراضي)", "flag": "🇹🇩"}
}
...
def get_country_info(code_str):
    ...
    # 2. استخراج كود الدولة الأساسي من الأرقام الخماسية (إذا كان الكود مثل 10016 أو 10227)
    if len(code_str) >= 4:
        possible_code = code_str.replace("100", "").replace("10", "")
        if possible_code in COUNTRY_MAP:
            return COUNTRY_MAP[possible_code]['name'], COUNTRY_MAP[possible_code]['flag']
            
        tail_code = str(int(code_str) % 100)
        if tail_code in COUNTRY_MAP:
            return COUNTRY_MAP[tail_code]['name'], COUNTRY_MAP[tail_code]['flag']

    # 3. محاولة مطابقة أحدث 3 أرقام
    ...
    # 4. احتياطي في حال عدم مطابقة أي قاعدة
