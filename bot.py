...
# ==================== 3. الواجهات والأزرار (مطابقة تماماً للواجهة الأولى) ====================
...
def callback_handler(call):
    ...
    # ---------------- إصلاح وتفعيل زر شحن الرصيد ----------------
        ...
        text = (f"💳 **طرق شحن الرصيد وشراء الاشتراكات:**\n\n"
                ...
                f"⚠️ **ملاحظة هامة:** بعد التحويل، يرجى تصوير السند وإرساله مع رقم الـ ID الخاص بك (`{user_id}`) إلى الإدارة للتفعيل الفوري عبر المعرف:\n"
                f"👉 {ADMIN_USERNAME}")
        bot.edit_message_text(text, chat_id, message_id, parse_mode="Markdown", reply_markup=back_markup)
