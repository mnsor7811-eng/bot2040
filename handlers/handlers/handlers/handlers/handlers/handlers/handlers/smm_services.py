...
from keyboards import smm_main_keyboard, smm_servers_keyboard, boost_keyboard, games_keyboard, dynamic_smm_keyboard, smm_detail_grid_keyboard

def register_smm_services_handler(bot: TeleBot):
