...
def register_general_handlers(bot: TeleBot):
    ...
    def send_welcome(message):
        ...
        welcome_text = (
            f"مرحباً بك عزيزي {name} في بوت الخدمات المتكامل 🤖✨\n\n"
            "يمكنك من خلال هذا البوت شراء الأرقام الوهمية، شحن ألعابك وبرامجك، ورشق وسائل التواصل الاجتماعي بسهولة تامة."
        )
