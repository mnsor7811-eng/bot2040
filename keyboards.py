...
def ready_accounts_keyboard():
    markup = InlineKeyboardMarkup()
    markup.add(InlineKeyboardButton("🦁 السيرفر 1 (بوت TG-Lion)", callback_data="ready_server_1"))
    markup.add(InlineKeyboardButton("🕷️ السيرفر 2 (بوت Spider Service)", callback_data="ready_server_2"))
    markup.add(InlineKeyboardButton("⏳ السيرفر 3 (حسابات قديمة - TG-Lion)", callback_data="ready_server_3"))
    markup.add(InlineKeyboardButton("🔙 العودة للقائمة الرئيسية", callback_data="back_main"))
    return markup
