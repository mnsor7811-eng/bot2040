...
def dynamic_smm_keyboard(services_list, category_code, page=0):
    ...
    # تحسين عدد العناصر بالصفحة الواحدة إلى 20 خدمة
    per_page = 20
    ...
    for srv in current_items:
        ...
        # ترجمة اسم الخدمة تلقائياً إلى العربية
        ...
        # قص الاسم حتى 40 حرفاً لضمان الوضوح التام على الشاشة
        short_name = translated_name[:40] + ("..." if len(translated_name) > 40 else "")
