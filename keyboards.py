...
def boost_keyboard():
    # تم تغيير الأزرار لترتبط بأرقام خدمات افتراضية (IDs) من موقع SMM. 
    # يمكنك تغيير الرقم الموجود بعد كلمة smm_ في حالة رغبتك بتغيير الخدمة مستقبلاً من الموقع
    markup = InlineKeyboardMarkup(row_width=1)
    markup.add(
        InlineKeyboardButton("📱 تيليجرام - متابعين", callback_data="smm_113"),
        InlineKeyboardButton("👁️ تيليجرام - مشاهدات", callback_data="smm_142"),
        InlineKeyboardButton("📸 انستجرام - متابعين", callback_data="smm_102"),
        InlineKeyboardButton("❤️ انستجرام - لايكات", callback_data="smm_105"),
        InlineKeyboardButton("🎵 تيك توك - مشاهدات", callback_data="smm_401"),
        InlineKeyboardButton("🎵 تيك توك - متابعين", callback_data="smm_405"),
        InlineKeyboardButton("📘 فيسبوك - متابعين", callback_data="smm_201"),
        InlineKeyboardButton("▶️ يوتيوب - مشاهدات", callback_data="smm_501"),
