...
def boost_keyboard():
    markup = InlineKeyboardMarkup(row_width=1)
    markup.add(
        InlineKeyboardButton("📱 - رشـق تيليجرام . telegram", callback_data="smmc_tg_mem"),
        InlineKeyboardButton("👁️ - مشاهدات تيليجرام . telegram views", callback_data="smmc_tg_view"),
        InlineKeyboardButton("📸 - رشـق انستا . instagram", callback_data="smmc_ig_fol"),
        InlineKeyboardButton("❤️ - لايكات انستا . instagram likes", callback_data="smmc_ig_like"),
        InlineKeyboardButton("🎵 - مشاهدات تيك توك . tiktok views", callback_data="smmc_tk_view"),
        InlineKeyboardButton("🎶 - متابعين تيك توك . tiktok followers", callback_data="smmc_tk_fol"),
        InlineKeyboardButton("📘 - رشـق فيسبوك . facebook", callback_data="smmc_fb_fol"),
        InlineKeyboardButton("▶️ - مشاهدات يوتيوب . youtube views", callback_data="smmc_yt_view"),
        InlineKeyboardButton("🔙 رجوع", callback_data="smm_main")
    )
    return markup
