...
# ==================== روابط ومعلومات القنوات الرسمية ====================
...
# ==================== قاعدة البيانات الدائمة والمحدثة ====================
...
# ==================== جلب دول السيرفر 1 والسيرفر 2 بنسبة ربح 10% ====================
...
def fetch_ready_accounts_api(server_id='1'):
    ...
    # قائمة دول السيرفر 1 (TG-Lion) مع زيادة نسبة الربح 10%
    server_1_data = [
    ...
    # قائمة دول السيرفر 2 (Spider TG) مع زيادة نسبة الربح 10%
    server_2_data = [
    ...
    chosen = server_1_data if server_id == '1' else server_2_data
    formatted = []
    for item in chosen:
    ...
    READY_ACCOUNTS_CACHE[server_id] = formatted
